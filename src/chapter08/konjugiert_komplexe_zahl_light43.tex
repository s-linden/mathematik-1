...
\begin{tikzpicture}[fixed ratio=4:3]
    ...
    \foreach \x in {-5,...,5} {
        ...
        \foreach \y in {-3,...,3} {
    	\draw[loosely dotted] (-5.8,\y) -- (5.8,\y);
    }
    % points
    \draw [dashed, thick, color=itwm_blue_04] (3,0) -- (3,2);
    \draw [dashed, thick, color=my_red] (0,2) -- (3,2);
    \draw [fill] (3,2) node [anchor=west] {$\; z = \textcolor{itwm_blue_04}{3} \textcolor{my_red}{+ 2}\mathrm{i}$} circle (0.1);
    %
    \draw [dashed, thick, color=itwm_blue_04] (3,0) -- (3,-2);
    \draw [dashed, thick, color=my_red] (0,-2) -- (3,-2);
    \draw [fill] (3,-2) node [anchor=west] {$\; \bar{z} =  \textcolor{itwm_blue_04}{3} \textcolor{my_red}{-2}\mathrm{i}\;$} circle (0.1);
